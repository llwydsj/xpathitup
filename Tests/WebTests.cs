...
namespace Tests
{
    ...
    public class WebTests
    {
        ...
        public void WebTest_Will_Not_Find_Non_Exisitng_Link_On_Page()
        {
            ...
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("a").Containing("Link to Page 3")));
        }
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("div").With.Attribute("class","NotValidClass")));
        }
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("a").Containing("Written by Someone famous")));
        }
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            string xpath = XPathFinder.Find.Tag("div").Containing("written by Torgeir Helgevold").ToXPathExpression();
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("div").With.Attribute("class", "MenuItem menuItemSelected").ToXPathExpression()));
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("div").With.Attribute("class", "menuItem MenuItemSelected").ToXPathExpression()));
        }
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            Assert.IsTrue(selenium.IsElementPresent("xpath=" + XPathFinder.Find.Tag("div").With.Attribute("CLASS", "menuItem menuItemSelected").ToXPathExpression()));
        }
        ...
        public void WebTest_Will_Not_Find_Text_Inside_Span_Test()
        {
            ...
            string xpath = XPathFinder.Find.Tag("p").Containing("Written by Torgeir Helgevold").ToXPathExpression();
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + xpath));
        }
        ...
        {
            LoadPage("http://www.unit-testing.net/Articles");
            string xpath = XPathFinder.Find.Tag("div").With.Attribute("class", "articleDetailsInner").ToXPathExpression();
            Assert.IsTrue(selenium.IsElementPresent("xpath=" + xpath));
        }
        ...
        public void WebTest_Will_Not_Find_Li()
        {
            ...
            string xpath = XPathFinder.Find.Tag("li").ToXPathExpression();
            Assert.IsFalse(selenium.IsElementPresent("xpath=" + xpath));
        }
