...
namespace Tests
{
    ...
    public class XPathFinderTest
    {
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Attribute("href", "http://test.test.com").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Text("Test").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "myClass").And.Attribute("attr1", "test1").And.Attribute("attr2","test2").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "myClass").And.Attribute("attr1", "test1").And.Attribute("attr2", "test2").And.Attribute("attr3", "test3").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").Containing("Home Page").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("div").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("div").Parent("div").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("span").Parent("div").Parent("div").ToXPathExpression();
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "someclass").ToXPathExpression();
        ...
        {
            XPathFinder.Find.HtmlTag(string.Empty);
        }
    }
}
