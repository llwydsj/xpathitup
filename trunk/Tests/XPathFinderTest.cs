...
namespace Tests
{
    ...
    public class XPathFinderTest
    {
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Attribute("href", "http://test.test.com").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Text("Test").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "myClass").And.Attribute("attr1", "test1").And.Attribute("attr2","test2").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "myClass").And.Attribute("attr1", "test1").And.Attribute("attr2", "test2").And.Attribute("attr3", "test3").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").Containing("Home Page").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("div").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("div").Parent("div").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("a").With.Parent("span").Parent("div").Parent("div").XPathExpression;
        ...
        {
            string xpath = XPathFinder.Find.HtmlTag("div").With.Attribute("class", "someclass").XPathExpression;
